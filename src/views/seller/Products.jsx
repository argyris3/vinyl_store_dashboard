                  ...
                  >
                    <div className="flex justify-start items-center gap-4">
                      <Link
                        ...
                        className="p-[6px] bg-slate-500 rounded hover:shadow-lg hover:slate-yellow-500/50"
                      >
                        {" "}
                        <FaEdit />{" "}
                      </Link>
                      ...
                      <Link
                        ...
                        className="p-[6px] bg-orange-400 rounded hover:shadow-lg hover:shadow-orange-500/50"
                      >
                        {" "}
                        <FaTrash />{" "}
                      </Link>
