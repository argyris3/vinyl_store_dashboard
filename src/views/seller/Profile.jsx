          ...
          <div className="w-full p-4 bg-[#6a5fdf] rounded-md text-[#d0d2d6]">
            <div className="flex justify-center items-center py-3">
              {userInfo?.image ? (
                <label
                  htmlFor="img"
                  className="h-[150px] w-[200px] p-3 cursor-pointer overflow-hidden"
                >
            ...
            <div className="px-0 md:px-5 py-2">
              <div className="flex flex-col justify-between text-sm  gap-2 p-4 bg-slate-800 rounded-md relative">
