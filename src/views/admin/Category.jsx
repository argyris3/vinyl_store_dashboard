...
const Category = () => {
  ...
  return (
    <div className="px-2 lg:px-7 pt-5">
      <div className="flex lg:hidden justify-between items-center mb-5 p-4 bg-[#3D3D3D] rounded-md">
      ...
      <div className="flex flex-wrap w-full">
        <div className="w-full lg:w-7/12">
          <div className="w-full p-4 bg-[#3D3D3D] rounded-md">
            <Search
        ...
        >
          <div className="w-full pl-5">
            <div className="bg-[#3D3D3D] h-screen lg:h-auto px-3 py-2 lg:rounded-md text-[#d0d2d6]">
              ...
              <form onSubmit={addOrUpdateCategory}>
                <div className="flex flex-col w-full gap-1 mb-3">
                  ...
                  <input
                    ...
                    className="px-4 py-2 focus:border-indigo-500 outline-none bg-[#ffffff] border border-slate-700 rounded-md text-black"
                    type="text"
                    id="name"
                    name="category_name"
                    placeholder=""
                ...
                <div className="mt-4">
                  <button
                    ...
                    className="bg-slate-800 w-full hover:shadow-red-300/50 hover:shadow-lg text-white rounded-md px-7 py-2 mb-3"
                  >
                    {loader ? (
                      <PropagateLoader
                        color="#fff"
