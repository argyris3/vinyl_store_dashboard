  ...
  return (
    <div className="px-2 md:px-7 py-5 bg-slate-600">
      <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-7">
        <div className="flex justify-between items-center p-5 bg-[#45474B] rounded-md gap-3">
          ...
          <div className="w-[40px] h-[47px] rounded-full bg-slate-700 flex justify-center items-center text-xl">
            <BsCurrencyEuro className="text-[#fae8e8] shadow-lg" />
          </div>
        </div>
      ...
      <div className="w-full flex flex-wrap mt-7">
        ...
        <div className="w-full lg:w-5/12 lg:pl-4 mt-6 lg:mt-0">
          <div className="w-full bg-sky-900 p-4 rounded-md text-[#d0d2d6]">
            ...
            <div className="flex flex-col gap-2 pt-6 text-[#d0d2d6]">
              <ol className="relative border-1 border-slate-600 ml-4">
                {recentMessage.map((m, i) => (
                  ...
                  rounded-lg border border-slate-600 shadow-sm"
                    >
      ...
      <div className="w-full p-4 bg-[#16404D] rounded-md mt-6 ">
        <div className="flex justify-between items-center ">
          <h2 className="font-semibold text-lg text-[#d0d2d6] pb-3">
            Recent Orders
          </h2>
        ...
        <div className="relative overflow-x-auto">
          <table className="w-full text-sm text-[#d0d2d6] text-left ">
            <thead className="uppercase border-b border-slate-700 text-sm text-[#d0d2d6]">
              <tr>
