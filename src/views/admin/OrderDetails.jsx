      ...
      <div className="w-full p-4 bg-gray-600 rounded-md">
        <div className="flex justify-between items-center p-4">
          ...
          <select
            ...
            name=""
            id=""
            className="px-4 py-2 focus:border-gray-500 outline-none bg-[#475569] border border-slate-700 rounded-md text-[#d0d2d6]"
          >
          ...
          <div className="flex flex-wrap">
            <div className="w-[60%]">
              <div className="pr-3 text-[#d0d2d6] text-lg">
                ...
                <div className="mt-4 flex flex-col gap-3 bg-gray-700 rounded-md">
            ...
            <div className="w-[60%]">
              <div>
                <div className="mt-4 flex flex-col bg-gray-800 rounded-md p-4">
