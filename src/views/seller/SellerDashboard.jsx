    ...
    >
      <div className="px-2 md:px-7 py-5">
        <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-7">
          <div className="flex justify-between items-center p-5 bg-slate-900 rounded-md gap-3">
            <div className="flex flex-col justify-start items-start text-[#5c5a5a]">
              <h2 className="text-3xl font-bold">${totalSale}</h2>
              <span className="text-md font-medium">Total Sales</span>
            </div>

            <div className="w-[40px] h-[47px] rounded-full bg-[#3c2709] flex justify-center items-center text-xl">
          ...
          <div className="flex justify-between items-center p-5 bg-slate-900 rounded-md gap-3">
            ...
            <div className="w-[40px] h-[47px] rounded-full bg-[#01081b] flex justify-center items-center text-xl">
          ...
          <div className="flex justify-between items-center p-5 bg-slate-900 rounded-md gap-3">
            ...
            <div className="w-[40px] h-[47px] rounded-full bg-[#043602] flex justify-center items-center text-xl">
          ...
          <div className="flex justify-between items-center p-5 bg-slate-900 rounded-md gap-3">
            ...
            <div className="w-[40px] h-[47px] rounded-full bg-[#0b0b57] flex justify-center items-center text-xl">
              <FaCartShopping className="text-[#fae8e8] shadow-lg" />
            </div>
          </div>
        </div>
        ...
        <div className="w-full flex flex-wrap mt-7">
          ...
          <div className="w-full lg:w-5/12 lg:pl-4 mt-6 lg:mt-0">
            <div className="w-full bg-slate-700 p-4 rounded-md text-[#d0d2d6]">
