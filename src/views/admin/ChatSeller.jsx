...
const ChatSeller = () => {
  ...
  return (
    <div className="px-2 lg:px-7 py-5">
      <div className="w-full bg-gray-900 px-4 py-4 rounded-md h-[calc(100vh-140px)]">
              ...
              {sellers.map((s, i) => (
                ...
                >
                  <div className="relative ">
                    ...
                    {activeSeller.some((a) => a.sellerId === s.s_id) && (
          ...
          <div className="w-full md:w-[calc(100%-200px)] md:pl-4">
            <div className="flex justify-between items-center">
              {sellerId && (
                <div className="flex justify-start items-center gap-3 ">
                  <div className="relative ">
                    <img
                      className="w-[45px] h-[38px] border-green-500 border-2 max-w-[45px] p-[2px] rounded-full"
            ...
            <form onSubmit={send} className="flex gap-3">
              <input
                ...
                type="text"
                className="w-full justify-between px-2 border border-slate-700 items-center py-[5px] focus:border-blue-500 rounded-md outline-none bg-transparent text-[#d0d2d6]"
